...
//  PrintRiseTransitSet2(JD, -7, Mercury_rise_transit_set);
  printf("\n\nxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx\n\n");
}
...
//  double JD = 2465483.5000000000;
  ...
  CAADate CalcDateToday(2017, 4, 2, true);
  double JD = CalcDateToday.Julian();
  for (int i=0; i<60; ++i)
  {
//    PrintMercuryInfo(JD, 122.0464,  47.98542, false);
//    PrintMercuryInfo(JD, 122.0464,  47.98542, true);
